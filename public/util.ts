...
const operations: Operation[] = [
  ...
  {
    name: "Increment Post Quality",
    endpoint: "/api/posts/:id/increment-quality",
    method: "PATCH",
    fields: { id: "input" },
  },
  {
    name: "Decrement Post Quality",
    endpoint: "/api/posts/:id/decrement-quality",
    method: "PATCH",
    fields: { id: "input" },
  },
  {
  ...
  },
  {
    ...
    method: "POST",
    fields: { owner: "input", title: "input" },
  },
  {
    name: "Create Collection",
    endpoint: "/api/collections/create",
    method: "POST",
    fields: { owner: "input", parent: "input", title: "input", deadline: "input" },
  },
  {
  ...
  },
  {
    ...
    method: "POST",
    fields: { user: "input", to: "input", title: "input" },
  },
  {
    name: "Share Collsection",
  ...
  },
  {
    ...
    method: "POST",
    fields: { user: "input", from: "input", title: "input" },
  },
  {
  ...
  },
  {
    ...
    method: "PATCH",
    fields: { user: "input", title: "input", day: "input" },
  },
  {
  ...
  },
  {
    ...
    endpoint: "/api/collections/:title/add",
    method: "PATCH",
    fields: { user: "input", title: "input", content: "input" },
  },
  {
    name: "Remove from Collection",
    endpoint: "/api/collections/:title/remove",
    method: "PATCH",
    fields: { user: "input", title: "input", content: "input" },
  },
];
